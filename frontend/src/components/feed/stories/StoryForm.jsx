                  ...
                  >
                    <div className="relative">
                      <input
                        ...
                        className="w-full py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all text-gray-700 shadow-sm file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100"
                      />
                    </div>
                    ...
                    {previewImage && (
                      <motion.div 
                        initial={{ opacity: 0, y: 10 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="mt-3 rounded-xl overflow-hidden border border-gray-200 h-32 bg-gray-50 relative"
                      >
                        <img 
                          src={previewImage}
                          alt="Story preview"
