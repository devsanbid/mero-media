          ...
          <div className="flex space-x-5">
            {userDetails && (
              <motion.div whileHover={{ y: -5 }} className="flex-shrink-0">
                <Link to='/user/stories' className="flex flex-col items-center justify-center text-center cursor-pointer">
                ...
                <Link to={`/story/${story.id}`} className="flex flex-col items-center justify-center text-center cursor-pointer max-w-20">
                  <div className="relative">
                    ...
                    >
                      <div className="w-full h-full rounded-full overflow-hidden bg-white p-[2px]">
                        <img
                          src={getImageUrl(story.user.profilePicture) || '/default-avatar.png'}
