...
const ProfilePicVerify = () => {
  ...
  const assignedProfilePicture = profilePictures.find((pic) => pic === user?.profilePicture) || "https://res.cloudinary.com/datvbo0ey/image/upload/v1726651745/3d%20avatar/1_ijpza2.png";
  ...
  if (!isLoggedIn || !user || user.isDpVerify) return null;
