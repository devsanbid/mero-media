...
export default function SignupForm() {
  ...
  useEffect(() => {
    if (watchedPassword) {
      ...
      if (/\d/.test(watchedPassword)) score += 1;
        ...
        return (
          ...
          >
            ...
            <div className="space-y-4">
              ...
              {errors.username && (
                <p className="text-red-500 text-sm ml-2">{errors.username.message}</p>
              )}
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 bg-gradient-to-br from-blue-50 via-indigo-50 to-violet-50 relative overflow-hidden flex flex-col justify-between">
        ...
        <div className="px-8 pt-12 md:pt-24 text-gray-800 relative z-10">
          <li href="/" className="inline-block mb-12">
        ...
        <div className="w-full max-w-md">
          ...
          {apiError && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="mb-6 p-4 rounded-lg bg-red-50 text-red-600 text-sm"
            >
              {apiError}
            </motion.div>
          )}
          ...
          {successMessage && (
            <motion.div
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
              className="mb-6 p-4 rounded-lg bg-green-50 text-green-600 text-sm"
            >
              {successMessage}
            </motion.div>
          )}
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            ...
            <p className="text-center text-sm text-gray-500">
              ...
              and{" "}
              <li href="/privacy" className="text-blue-600 hover:text-blue-700 transition-colors">
                Privacy Policy
              </li>
            </p>
          </div>
