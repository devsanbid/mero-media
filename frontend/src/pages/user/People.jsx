...
import {
  ...
  FiEye, FiChevronDown, FiChevronUp, FiUsers, FiHeart, FiMapPin
} from 'react-icons/fi';
      ...
      >
        <div className="relative">
          ...
          <div className="h-28 bg-gradient-to-r from-blue-400 to-indigo-500 relative">
            <img 
              src={user.coverImage || 'https://via.placeholder.com/500x200?text=Cover+Image'} 
        ...
        <div className="pt-14 pb-5 px-5">
          <div className="text-center mb-4">
            <Link to={`/user/profile/${user.id}`} className="group">
          ...
          <div className="container mx-auto px-4 py-4">
            ...
            <div className="flex overflow-x-auto mt-4 pb-1 gap-2">
              {[
                ...
                { id: 'friends', label: 'Friends', icon: <FiUserCheck />, count: friendsList.length },
                { id: 'requests', label: 'Requests', icon: <FiClock />, count: receivedRequests.length },
                { id: 'sent', label: 'Sent', icon: <FiClock />, count: sentRequests.length },
              ].map((tab) => (
                <button
                  key={tab.id}
