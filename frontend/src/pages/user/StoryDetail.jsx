  ...
  return (
    <AuthRedirect>
      <div className="bg-gradient-to-br from-indigo-50 to-purple-50 flex flex-col-reverse lg:flex-row items-center justify-between min-h-screen fixed h-full w-screen z-50 inset-0 lg:overflow-hidden overflow-y-auto">
        ...
        >
          <Link to="/user/home" className="bg-white/80 backdrop-blur-md text-indigo-600 px-4 py-2.5 rounded-full shadow-lg hover:bg-indigo-600 hover:text-white transition-all duration-300 flex items-center text-sm font-medium">
